document.addEventListener("DOMContentLoaded", () => {
    ...
    if (loginForm) {
        loginForm.addEventListener("submit", async (e) => {
            ...
            btn.disabled = true; // Vô hiệu hóa nút đăng nhập
            btn.textContent = "Đang xử lý..."; // Thay đổi nội dung nút thành "Đang xử lý"
            ...
            btn.disabled = false; // Kích hoạt lại nút sau khi xử lý xong
            btn.textContent = "Đăng nhập"; // Khôi phục lại nội dung nút
    ...
    if (regForm) {
        ...
        regForm.addEventListener("submit", async (e) => {
            e.preventDefault();
            btn.disabled = true; // Vô hiệu hóa nút đăng ký
            btn.textContent = "Đang xử lý..."; // Thay đổi nội dung nút thành "Đang xử lý"
            ...
            btn.disabled = false; // Kích hoạt lại nút sau khi xử lý xong
            btn.textContent = "Đăng ký"; // Khôi phục lại nội dung nút
