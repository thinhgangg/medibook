...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function renderDates() {
        ...
        view.forEach((d, i) => {
            ...
            item.type = "button";
            item.className = ["abk-date-item", d.full ? "full" : "avail", idx === activeIndex ? "active" : ""].join(" ");
    ...
    function renderSlots() {
        ...
        day.slots.forEach((s) => {
            ...
            btn.type = "button";
            btn.className = "abk-slot" + (s.disabled ? " disabled" : "") + (selectedSlotId === s.id ? " selected" : "");
